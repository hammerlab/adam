...
import htsjdk.variant.variantcontext.{ Allele, GenotypeBuilder, GenotypeLikelihoods, VariantContextBuilder, Genotype ⇒ HtsjdkGenotype, VariantContext ⇒ HtsjdkVariantContext }
